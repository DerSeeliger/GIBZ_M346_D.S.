# E-1-I: Shared execution role — AWS Academy provides LabRole with broad permissions.
# Outside Academy, swap this for a purpose-built IAM role with lambda/logs permissions.
